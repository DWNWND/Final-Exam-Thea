...
export default function ListingSpecific(): JSX.Element {
  ...
  useEffect(() => {
    if (listing) {
      ...
      const calculatedNights = calculateNights(savedDates.startYYYYMMDD, savedDates.endYYYYMMDD);
      const price = calculatedNights * listing.price;
      setTotalPrice(price);
      setNights(calculatedNights);
    }
  }, [listing, savedDates, setSelectedListing, userName]);
...
// export default function ListingSpesific(): JSX.Element {
//   const { selectedListing, setSelectedListing } = useBookingDataStore();
//   const { setInitialDates, savedDates } = useTravelDatesStore();
//   const { userName } = useAuthStore();
//   const { travelSearchData } = useTravelSearchStore();

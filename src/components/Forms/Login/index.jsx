...
export default function LoginForm() {
  ...
  return (
    <div className="max-w-md mx-auto px-8 pt-6 pb-8 mb-4">
      <h1 className="text-2xl mb-6 uppercase text-primary-green">Login</h1>
      ...
      <Link to="/#" className="block text-sm underline mt-4 text-primary-green hover:text-primary-blue">Forgot your password?</Link>
      <Link to="/register" className="block text-sm underline mt-4 text-primary-green hover:text-primary-blue">Register new user</Link>
    </div>
  );
}

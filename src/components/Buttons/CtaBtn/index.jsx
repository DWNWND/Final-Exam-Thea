export default function CtaBtn({ innerText, tailw, color, mainCta }) {
  if (mainCta) {
    return <button className={`${tailw} w-full p-2 px-20 flex justify-center font-semibold text-xl text-white uppercase hover:shadow-md hover:bg-primary-light lg:max-w-8`}>{innerText}</button>;
  } else {
